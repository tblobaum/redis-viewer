...
(function() {
  var app, argv, express, io, ip, key_command_map, pass, port, redis, redis_client, reply_types, socket, _, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;

  process.title = 'redis-viewer';

  argv = require('optimist').argv;

  ip = (_ref = (_ref1 = argv.ip) != null ? _ref1 : argv.i) != null ? _ref : '127.0.0.1';

  port = (_ref2 = (_ref3 = argv.port) != null ? _ref3 : argv.p) != null ? _ref2 : 6379;

  pass = (_ref4 = (_ref5 = argv.pass) != null ? _ref5 : argv.x) != null ? _ref4 : false;
